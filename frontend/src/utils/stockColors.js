...
import { getStockColor, getStockColors, getPaletteColor } from '../utils/stockColors';
            ...
            {symbols.map(symbol => (
                <button
                    ...
                    style={activeStock === symbol ? {
                        backgroundColor: getStockColor(symbol),
                    } : {}}
                >
                    {symbol}
                </button>
                                        ...
                                        <div className="flex items-center gap-4 mb-3">
                                            ...
                                            <div className="flex items-center gap-3 text-xs text-gray-500">
                                                <span className="flex items-center gap-1.5">
                                                    <span className="w-5 h-0.5 rounded" style={{ backgroundColor: getStockColor(activeIndicatorStock) }}></span>
                                                    Price
                                                </span>
                                                <span className="flex items-center gap-1.5">
                                        ...
                                        <ResponsiveContainer width="100%" height={250}>
                                            <LineChart data={indicatorData}>
                                                ...
                                                <Line
                                                    ...
                                                    stroke={getStockColor(activeIndicatorStock)}
                                                    strokeWidth={2}
                                                    dot={false}
                                                    connectNulls
                                                />
